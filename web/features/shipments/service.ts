/* ================================================================== */
/*  PORTKEY — Shipments Feature Service (Vertical Slice)               */
/*  CRUD operations, search, filtering, and analysis for shipments.    */
/* ================================================================== */
...
/**
 * Fetch shipments for the current user (broker sees own, admin sees all).
 * Supports optional filtering by status, lane, and keyword search.
 */
...
/**
 * Fetch a single shipment by ID (includes nested items and documents).
 */
 ...
 */
export async function advanceShipmentStatus(id: number): Promise<Shipment> {
...
/**
 * Soft-delete a shipment (sets deletedAt timestamp, doesn't remove from DB).
 */
